...
mission_plan = ["INIT", "TAKEOFF", "HOVER", "MOVE TO [5,0,3,0,0,0]", "HOVER", "PHOTOTWIRL", "HOVER", "MOVE TO [0,0,3,0,0]", "HOVER", "LANDING", "IDLE"]
...
def main():
    ...
    def transition_to(new_state):
        ...
        if state == 'IDLE':
            ...
            raise TypeError("State name error: No such state exists. ")
